            ...
            <div className="bg-[var(--clr-dark-slate)] border border-[var(--clr-accent)]/20 rounded-2xl overflow-hidden h-full hover:border-[var(--clr-accent)]/70 transition-all duration-300 relative">
                ...
                <div className="relative p-6 flex flex-col">
                    ...
                    <div className="flex items-center gap-4 mt-auto">
                        <a href={project.repoUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-[var(--clr-accent)] hover:text-[var(--clr-accent)] transition-colors">
                            <Github className="w-4 h-4" /> Code
                        </a>
                        <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-[var(--clr-accent)] hover:text-[var(--clr-accent)] transition-colors">
                        ...
                        {project.detailsUrl && (
                            <motion.a
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="ml-auto flex items-center gap-2 px-4 py-2 bg-[var(--clr-accent)]/10 border border-[var(--clr-accent)]/30 rounded-lg text-sm text-[var(--clr-accent)] hover:bg-[var(--clr-accent)]/20 transition-colors"
                            >
                                View Details
                            </motion.a>
                        )}
